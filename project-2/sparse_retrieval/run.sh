...
echo "after build index"
##########################################################
# Then, search and store result in the trec_eval format. #
##########################################################
python codes/main.py --query ../data/topics.401-440.txt --method bm25 --output runs/bm25_1.run
...
perl ./trec_eval.pl ../data/qrels.401-440.txt runs/bm25_1.run
